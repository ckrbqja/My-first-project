		           ...
		           <!-- 페이징 3 제목 -->
		            ...
		            <!-- 페이징 3 제목 -->
		                ...
		                <!-- 페이징 3 내용-->
		                    <div class="word p3 hidden">
		                        <p></p><p>솔렌터카 계약 앱에서 정보제공동의 / 이름, 주민번호 입력 후 아래 기관에 신용정보를 조회하며,&nbsp; 공인인증서 인증 및 safekey 발급이 필요합니다. 해당 정보는 조회를 위해서만 사용되며 저장되지 않습니다.<br>&nbsp;&nbsp;</p><p>&nbsp; &nbsp;&nbsp; -&nbsp; 민원24 : 주민등록등본 <br>&nbsp;&nbsp;&nbsp;&nbsp; -&nbsp; 홈텍스 : 납세내역, 소득증명, 사업자등록 <br>&nbsp;&nbsp;&nbsp;&nbsp; -&nbsp; 건강보험관리공단 : 자격득실내역<br>&nbsp;&nbsp;&nbsp;&nbsp; -&nbsp; 경찰청 : 운전면허증&nbsp;</p><p></p>
		                    </div>
		                <!-- 페이징 3 내용-->  
		            ...
		            <div class="list a2">
		             ...
		             <!-- 페이징 3 제목--> 
		               ...
		               <!-- 페이징 2 내용--> 
						<div class="word p2 hidden">
							<p></p><p>솔렌터카에서는 다른 이용 고객에게 위해(알레르기 등)를 끼칠 우려가 있어 반려동물의 동승을 허용하지 않는 점 양해부탁드립니다.&nbsp;</p><p></p>
		                </div>   
		               <!-- 페이징 2 내용--> 
		            ...
		            <div class="subject p3 hidden">
						<a href="#none" onclick="selectList('a4');">
							 <span class="cl-point1">[다이렉트]</span>
		                     <strong>솔렌터카 앱에서는 계약이 불가한가요?</strong>
						</a>
					</div>
		            <!-- 페이징 3 제목-->  
		                ...
		                <div class="notice a4a" style="display: none;">
		                 ...
		                 <!-- 페이징 1 내용-->
		                    <div class="word p1">
		                        <p></p><p>솔렌터카 내륙지점 이용 시 사전 예약을 통해 '편도 반납서비스' 이용이 가능합니다.</p><p>&nbsp;</p><p>※ 단, 현행 관계법 상 차량 등록 지역 외 대여 영업을 할 수 없어 편도 반납 시 회차 거리에 따른 편도수수료가 별도 부과됩니다.</p><p>&nbsp;</p><p>자세한 사항은 솔렌터카 고객센터(1599-9111)로 문의 주시면 친절히 안내해 드리겠습</p>니다. <p>&nbsp;</p><p>예시 : 서울 서대문지점에서 차량 대여 후 부산지점에 차량 반납 가능 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (회차 거리에 따른 편도수수료 발생)&nbsp;</p><p></p>
		                    </div>
		                 <!-- 페이징 1 내용-->
		                
		                  <!-- 페이징 2 내용--> 
		                   	<div class="word p2 hidden">
		                   		<p></p><p>예약 변경은 솔 렌터카 홈페이지에서 변경을 원하시는 일정에 차량 대여 가능 여부 확인 후 재 예약으로 진행해주셔야 하며,</p><p>재 예약 진행 후 기존 예약 내역은 취소 부탁드립니다.</p><p>실시간으로 예약이 진행되고 있어 재 예약 진행 시 반드시 이용 가능 여부를 먼저 확인 부탁드립니다.&nbsp;</p><p></p>
		                    </div>
		                  <!-- 페이징 2 내용--> 
		                   
		                  <!-- 페이징 3 내용--> 
		                    <div class="word p3 hidden">
		                    	<p></p><p>솔렌터카 앱에서 견적내기 후 솔렌터카 계약앱에서 계약 진행이 가능합니다. <br>(솔렌터카 계약앱 다운로드 안내 SMS가 발송됩니다.)&nbsp;</p><p></p>
		                    </div>
		                  <!-- 페이징 3 내용-->  
		            ...
		            <div class="subject p3 hidden">
		             ...
		             <!-- 페이징 3 제목-->    
		                ...
		                <!-- 페이징 1 내용-->
		                    <div class="word p1">
		                        <p></p><p>솔렌터카는 전 연령차량은 보유 및 대여하고 있지 않습니다. </p><p>차량 사고는 자칫 인명 피해로 이어질 수 있어 고객의 안전을 위해 차종 별 대여 가능 자격을 규정하였으며, 차량 별 대여자격은 '솔렌터카 홈페이지&gt;단기렌터카&gt;단기렌터카안내&gt;'대여자격'에서 확인하실 수 있습니다.&nbsp;</p><p></p>
		                    </div>
		                <!-- 페이징 1 내용-->    
		                  ...
		                  <!-- 페이징 3 내용--> 
		                    <div class="word p3 hidden">
		                    	<p></p><p>솔렌터카 온라인/모바일 접속 &gt; MY렌터카 &gt;발주현황 &gt; 탁송예정일 확인<br>&nbsp;* 발주현황 확인은 계약이 완료된 이후부터 확인가능합니다.&nbsp;</p><p></p>
		                    </div>
		                  <!-- 페이징 3 내용-->  
		            ...
		            <div class="subject p3 hidden">
		             ...
		             <!-- 페이징 3 제목-->  
		                ...
		                <!-- 페이징 1 내용-->
		                    <div class="word p1">
		                        <p></p><p>유아용품은 솔렌터카 제주지점 이용 시에만 대여 가능합니다.</p><p>&nbsp;</p><p>'카시트/유모차 등의 유아용품은 협력업체인 "제주아이"(<a href="http://www.jeju-i.com">http://www.jeju-i.com</a>)를 통해 예약이 가능합니다.</p><p>&nbsp;</p><p>유아용품 예약문의 : 제주아이 (☏ 064-748-7799)</p><p>&nbsp;</p><p></p>
		                    </div>
		                <!-- 페이징 1 내용-->
		           ...
		           <!-- 페이징 2 제목--> 
		            ...
		            <!-- 페이징 3 제목-->  
		                ...
		                <!-- 페이징 1 내용-->  
		                  ...
		                  <!-- 페이징 2 내용--> 
		                   	<div class="word p2 hidden">
		                   		<p></p><p>솔렌터카 로그인 후 MY렌터카에서 견적확인을 하실 수 있습니다.&nbsp;</p><p></p>
		                    </div>
		                  <!-- 페이징 2 내용--> 
		            ...
		            <!-- 페이징 3 제목-->  
		                ...
		                <div class="notice a9a" style="display: none;">
		                 ...
		                 <!-- 페이징 1 내용--> 
		                  ...
		                  <!-- 페이징 3 내용--> 
		                    <div class="word p3 hidden">
		                    	 <p></p><p>1. 솔렌터카 온라인/모바일 접속<br>2. 회원가입 또는 기존고객 로그인(렌탈료 견적산출을 위해 회원가입 및 로그인 필요)<br>3. Car&amp;Life 배너에서 다이렉트 견적 아이콘 클릭<br>4. A.I 추천 또는 차량 직접 선택 클릭 후 검색<br>5. 원하시는 차량과 트림을 정하시고 견적내기 클릭<br>&nbsp;&nbsp; (상세차량 및 옵션선택, 렌트조건을 선택 시 하단에 월렌탈료 실시간 확인 가능)&nbsp;</p><p></p>
		                    </div>
		                  <!-- 페이징 3 내용-->  
