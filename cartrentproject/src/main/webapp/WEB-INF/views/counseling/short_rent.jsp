              ...
              <article><!-- 이용약관 -->
                    ...
                    <div class="article-content">
                        <div class="terms-listbox">
							<p class="terms-listbox__text">KS렌터카㈜는 적법하고 공정한 방법으로 개인정보를 수집하며, 고객의 개인정보를 최우선으로 생각하여 안전하게 보유·관리하고 있습니다.</p>
							...
							<div class="terms-list v3 list"  onclick="btnSlide('a3');">
								...
								<div class="terms-content notice" id="a3">
									...
									제1조 (약관의 목적 및 적용)
									1. KS렌터카㈜(이하 "회사"라 한다)는 이 약관(이하 "본 약관"이라 한다)에 따라 대여자동차(이하 "렌터카"라 한다)를 임차인에게 임대하고 임차인은 이를 임차한다.
									...
									3. 회사가 전항에 의한 객관적인 산정자료를 제시하지 않을 경우 임차인은 수리 기간 또는 재구매 및 등록에 소요되는 기간에 해당하는 대여요금의 50%를 부담한다. 이때 대여요금은 수리 기간 또는 재구매 및 등록에 소요되는 기간에 해당하는 1일 대여요금을 기준으로 산정하며, 이 때 대여요금의 기준은 사고가 발생한 날 회사 홈페이지(www.kscarrental.com)에 게시된 대여요금(제휴 할인이 되지 않은 요금)을 기준으로 한다.
							...
							<div class="terms-list v3 list">
								...
								<div class="terms-content notice" id="a6">
									<table class="tb-cnt">
										...
										<tr>
											<td class="text-c">KS네트웍스(주)</td>
											<td>렌터카 차량 긴급출동 서비스</td>
										</tr>
										<tr>
											<td class="text-c">KS네트웍스(주) 스피드메이트 가맹점 : <br>강서공장 외 600여 개소<br>
